    ...
    <form   method = "post" style = "margin-left:25%;">
        <div class="card" id = "card" style= "width:63%;" >
             <h1 style = "text-align:center; font-style:bold; font-family:'sitara',sans-serif;"> Student SignUp </h1>
                ...
                <input class= "txt-input" type= "password" style= "margin-left:72px;" id= "psw1" oninput="verifyPassword(this)">
                <br> <br>

                <label for= "reEnterPassword" style= " font-family:'sitara',sans-serif; font-weight:bold;margin-left:60px;">Password re-type </label>
                <input class= "txt-input" type= "password" style= "margin-left:15px;" id= "psw2" oninput="verifyPassword(this)" >
                <br> <br>

                
                <input type= "submit" value= "SignUp Now" class= "btt type1" style = "align-items:center; margin-left: 40%;">
                <br> <br>
