                ...
                <td style="padding: 15px;">
                    ...
                    <div class="card" style="width:max-content;margin:0px;">
                        ...
                        <div style="margin-left:30px; font-family:'sitara',sans-serif;font-weight:bold; font-size:12px;">
                            ...
                            <p> Address<span style="margin-left: 9px;"> :</span><span style="margin-left: 31px;"> Faculty Of Medicine,</span></br>
                                <span style="margin-left: 98px;"> SORIS university, </span><br>
                                <span style="margin-left: 98px;"> Colombo </span>
                            </p>
                        </div>
                    </div>
                </td>
                ...
                <td style="padding: 15px;"> 
                    ...
                    <div class="card" style="width:max-content;margin:0px;">
                        ...
                        <div style="margin-left:30px; font-family:'sitara',sans-serif;font-weight:bold; font-size:12px;">
                            ...
                            <p> Address<span style="margin-left: 9px;"> :</span><span style="margin-left: 31px;"> Faculty Of Engineering,</span></br>
                                <span style="margin-left: 98px;"> SORIS university, </span><br>
                                <span style="margin-left: 98px;"> Colombo </span>
                            </p>
                        </div>
                ...
                <td style="padding: 15px;">
                    ...
                    <div class="card" style="width:max-content;margin:0px;">
                        ...
                        <div style="margin-left:30px; font-family:'sitara',sans-serif;font-weight:bold; font-size:12px;">
                            ...
                            <p> Address<span style="margin-left: 9px;"> :</span><span style="margin-left: 31px;"> Faculty Of Computing,</span></br>
                                <span style="margin-left: 98px;"> SORIS university, </span><br>
                                <span style="margin-left: 98px;"> Colombo </span>
                            </p>
                        </div>
                ...
                <td style="padding: 15px;">
                    ...
                    <div class="card" style="width:max-content;margin:0px;">
                        ...
                        <div style="margin-left:30px; font-family:'sitara',sans-serif;font-weight:bold; font-size:12px;">
                            ...
                            <p> Address<span style="margin-left: 9px;"> :</span><span style="margin-left: 31px;"> Faculty Of Business,</span></br>
                                <span style="margin-left: 98px;"> SORIS university, </span><br>
                                <span style="margin-left: 98px;"> Colombo </span>
                            </p>
                        </div>
                ...
                <td style="padding: 15px;">
                    ...
                    <div class="card" style="width:max-content;margin:0px;">
                        ...
                        <div style="margin-left:30px; font-family:'sitara',sans-serif;font-weight:bold; font-size:12px;">
                            ...
                            <p> Address<span style="margin-left: 9px;"> :</span><span style="margin-left: 31px;"> Faculty Of Art,</span></br>
                                <span style="margin-left: 98px;"> SORIS university, </span><br>
                                <span style="margin-left: 98px;"> Colombo </span>
                            </p>
                        </div>
                ...
                <td style="padding: 15px;">
                    ...
                    <div class="card" style="width:max-content;margin:0px;">
                        ...
                        <div style="margin-left:30px; font-family:'sitara',sans-serif;font-weight:bold; font-size:12px;">
                            ...
                            <p> Address<span style="margin-left: 9px;"> :</span><span style="margin-left: 31px;"> Faculty Of Language,</span></br>
                                <span style="margin-left: 98px;"> SORIS university, </span><br>
                                <span style="margin-left: 98px;"> Colombo </span>
                            </p>
                        </div>
