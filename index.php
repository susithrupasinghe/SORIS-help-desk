    ...
    <div class="body-container">
        ...
        <table>
            <tr>
                ...
                <a href="#information" style="text-decoration: none;color:#000000;">
                        <div class="card" style="width: 50%;height:120px;width:150px;padding-left:50px;">
                ...
                <a href="#NEWS" style="text-decoration: none;color:#000000;">
                    <div class="card" style="width: 50%;margin-left:200px;margin-right:200px;height:120px;width:150px;padding-left:50px;">
                            <svg width="84" height="84" viewBox="0 0 74 62" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="#new inquiry" style="text-decoration: none;color:#000000;">
                <div class="card" style="width: 50%;margin-left:80px;height:120px;width:150px;padding-left:50px;">
                        <svg width="84" height="84" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
